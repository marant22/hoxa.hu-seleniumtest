...
public class SeleniumTest {
    ...
    public void testProfileSetting() {
        ...
        wait.until(ExpectedConditions.urlToBe("https://www.hoxa.hu/adatlap-578160")); // Wait until the URL changes to
        ...
        Assert.assertEquals(text, profilePage.WriteMotto(text));
